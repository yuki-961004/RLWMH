...
multiRL.model <- multiRL::run_m(
  ...
  funcs = list(lrng_func = lrng_hwm, prob_func = prob_hwm)
)
...
recovery <- multiRL::rcv_d(
  ...
  funcs = list(list(lrng_func = lrng_hwm, prob_func = prob_hwm)),
...
save(recovery, file = "../OUTPUT/recovery.HWM(-decay).Rdata")
```
...
save(replay.recovery, file = "../OUTPUT/replay.recovery.HWM(-decay).Rdata")

p <- plot(x = replay.recovery)
ggplot2::ggsave(
  plot = p$param[[1]]$alpha, filename = "../HWM(-decay)_alpha.png",
  width = 5, height = 5
)
ggplot2::ggsave(
  plot = p$param[[1]]$weight, filename = "../HWM(-decay)_weight.png",
  width = 5, height = 5
)
ggplot2::ggsave(
  plot = p$param[[1]]$capacity, filename = "../HWM(-decay)_capacity.png",
  width = 5, height = 5
)
...
save(fitting, file = "../OUTPUT/fitting.HWM(-decay).Rdata")
```
